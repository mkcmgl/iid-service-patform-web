        ...
        <div class="flex justify-between py-4 mb-4 topSearchBorder">
            <div class="flex-1 mr-8 grid gap-3 grid-cols-3 gap-x-4">
                <div class="flex items-center max-w-[500px]">
                    <span class="mr-4 w-28">应用名称</span>
                    <el-select
                        v-model="state.form.appId"
                        filterable
                        clearable
                        placeholder="请输入/选择应用名称"
                    >
                        <el-option
                ...
                <div class="flex items-center max-w-[500px]">
                    <span class="mr-4 w-28">申请状态</span>
                    <el-select
                                ...
                                scope.row.processApprovalStatus == 0
                                    ...
                                    : scope.row.processApprovalStatus == 1
                                      ...
                                      : scope.row.processApprovalStatus == 2
                                        ? `申请驳回:${JSON.parse(scope.row.processDisapprovalReason).desc}`
                                        : '申请通过'
                            }}
                        </div>
                    </template>
                ...
                <el-table-column label="操作" width="80">
                    <template #default="scope">
                        <el-button
                            :disabled="
                                scope.row.processApprovalStatus == '1' ||
                                scope.row.processApprovalStatus == '3'
                            "
                            :class="
                                scope.row.processApprovalStatus == '1' ||
                                scope.row.processApprovalStatus == '3'
